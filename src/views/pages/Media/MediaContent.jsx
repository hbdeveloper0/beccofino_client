                ...
                <Container>
                    ...
                    <Grid container spacing={3} sx={{ mt: 4 }}>
                        {Images.slice(0, displayedImages).map((Image) => (
                            <Grid item xs={3}>
                                <img src={Image} alt='Img' style={{ height: 200, width: '100%' }}/>
                            </Grid>
                        ))} 
                    </Grid>

                    <Box sx={{ mt: 5, display: 'flex', justifyContent: 'center'}}><GlobelButton onClick={ () => loadMoreImages()}  value={'Load More'}/></Box>
                </Container>
            </Grid>
        </div>
    )
