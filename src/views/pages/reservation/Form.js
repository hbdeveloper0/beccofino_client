                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={12} lg={4} sx={{pt:"0px !important"}}>
                            <Grid>
                                ...
                                <Grid sx={{pt:25}}>
                               <Divider />
                               <Typography  sx={{color:"#ffff",textAlign:"center",pt:1}}>Get in Touch</Typography>
                               <Typography  sx={{color:"#ffff",textAlign:"center",pt:1}}>+9200123456789</Typography>
                               <Typography  sx={{color:"#ffff",textAlign:"center",pt:1,pb:2 }}>info@BeccofinoTampa.com</Typography>
                        ...
                        <Grid item xs={12} lg={8} sx={{p:"0px !important"}}>
                            ...
                            >
                                <TabPanel value={value} index={0}>
                                 <Grid>
                                 <Typography variant='h5' sx={{p:3,boxShadow:2}} >Menu Selection</Typography>
                                 </Grid>
                                 <Grid sx={{p:6}}>
                               ...
                               sdsd
                                ...
                                <Grid>
                                 <Typography variant='h5' sx={{p:3,boxShadow:2}} >Your Information</Typography>
                                 </Grid>
                                 <Grid sx={{p:3}}>
                                 
                                 <Grid container spacing={2}>
                                 <Grid item xs={6}>
                                 <Typography sx={{pb:1}} ><span style={{color:"red"}}>*</span>First Name:</Typography>
                                 ...
                                 <Grid item xs={6}>
                                 <Typography sx={{pb:1}} ><span style={{color:"red"}}>*</span>Email:</Typography>
                                 <TextField fullWidth id="outlined-email-address" placeholder="Email Address" />
                                 </Grid>
                                 <Grid item xs={6}>
                             ...
                             />
                                 ...
                                 <Grid item xs={6}>
                                 <Typography sx={{pb:1}} ><span style={{color:"red"}}>*</span>Zip Code:</Typography>
                                 <TextField fullWidth id="outlined-email-address" placeholder="Email Address" />
                                 </Grid>
                               </Grid>
                               </Grid>
                                ...
                                <Typography variant='subsubtitle1' sx={{color:"#ced1d4"}}>Menu</Typography>
                                <Grid container spacing={2}>
                                <Grid item xs={10} sx={{px:5}}>
                                Chef Table: 6 courses tasting menu ($150.00) x 2 people
                                </Grid>
                                <Grid item xs={2}>
                                 $300.00
                                </Grid>
